...
`
export default function Calidad1(){
  return(
    <Wrapper>
      ...
      <h3>Ventajas:</h3>
      <ul>
        <li><BsCheck style={{scale:"1.5"}}/> Profesionalización del servicio, es decir, contar con asesoría especializada y enfocada a resultados.</li>
        <li><BsCheck style={{scale:"1.5"}}/> Adquirir mayor autonomía para enfocarse en las actividades vitales de su negocio.</li>
        <li><BsCheck style={{scale:"1.5"}}/> Reducción de costos equivalentes de un área interna en cuanto a operación, formación continua y actualización del sistema.</li>
      </ul>
    </Wrapper>
  )
}